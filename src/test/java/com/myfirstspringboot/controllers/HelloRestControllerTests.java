package com.myfirstspringboot.controllers;
...
import com.myfirstspringboot.entities.Greeting;
...
public class HelloRestControllerTests {
  ...
  public void greetWithName() {
      Greeting response = template.getForObject("/rest?name=Pedro", Greeting.class);
      assertEquals("Hello, Pedro!", response.getGreeting());
  }
